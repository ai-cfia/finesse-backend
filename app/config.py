...
DEFAULT_ERROR_FILENAMES_FAILED = "finesse-data filenames fetch failed"
...
class Config:
    ...
    ERROR_FILENAMES_FAILED = os.getenv(
        "FINESSE_BACKEND_ERROR_FILENAMES_FAILED", DEFAULT_ERROR_FILENAMES_FAILED
    )
